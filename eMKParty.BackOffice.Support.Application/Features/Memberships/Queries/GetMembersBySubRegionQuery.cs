...
namespace eMKParty.BackOffice.Support.Application.Features.Memberships.Queries
{
    ...
    internal class GetMembersBySubRegionQueryHandler : IRequestHandler<GetMembersBySubRegionQuery, Result<List<MemberDto>>>
    {
        ...
        private readonly ILogger<GetMembersBySubRegionQueryHandler> _logger;

        public GetMembersBySubRegionQueryHandler(IUnitOfWork unitOfWork, IMembershipRepository membershipRepository, IConfiguration _config, IAesOperation securityService, IMapper mapper, ILogger<GetMembersBySubRegionQueryHandler> logger)
        {
